...
//        if (target is XmlAttributeValue) {
//            val attribute = target.parent
...
//    }
    ...
    private fun getReferences(element: PsiElement, attributeValue: XmlAttributeValue, attribute: XmlAttribute, tag: XmlTag, namespace: String): Array<PsiReference> {
